// api_tester_https.js - API Tester App (HTTPS Origin)
// Test arbitrary APIs from HTTPS origin to test CORS behavior with proper origin
...
(function() {
    ...
    const APITester = {
        ...
        buildUI: function() {
            document.title = 'API Tester - HTTPS Origin';
            ...
            header.innerHTML = `
                <h1>🧪 API Tester (HTTPS Origin)</h1>
                <p class="subtitle">Test arbitrary API endpoints from HTTPS origin</p>
    ...
    // Expose to window for testing (use proper naming convention)
    window.ApiTesterHttps = APITester;  // Matches test suite naming: api_tester_https -> ApiTesterHttps
